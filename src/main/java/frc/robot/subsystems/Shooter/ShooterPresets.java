...
public class ShooterPresets {
    ...
    public static final double NEUTRAL_ANGLE = 18;

    // Opposite alliance zone shot - NEEDS TUNING
    public static final double OPPOSITE_RPM = 3050;
    public static final double OPPOSITE_ANGLE = 18;
    ...
    public static final double OUTPOST_RPM = 2720;//2520
