...
public class Module {
    ...
    // -------------------------------
    // PLACEHOLDER OFFSETS — YOU MUST REPLACE THESE
    // -------------------------------
    /**
     * These offsets align the CANcoder's absolute angle to the wheel's "zero" direction.
     * You MUST measure these on your robot.
     *
     * How to measure offsets:
     *  1. Put robot on blocks.
     *  2. Manually point each wheel so it faces perfectly forward.
     *  3. Read CANcoder absolute position in Tuner X.
     *  4. Put that value (0–1 rotations) into this array.
     */
    private static final double[] STEER_OFFSETS = {
            0.123,   // FRONT LEFT  (placeholder)
            0.456,   // FRONT RIGHT (placeholder)
            0.789,   // BACK LEFT   (placeholder)
            1.234    // BACK RIGHT  (placeholder)
    };
